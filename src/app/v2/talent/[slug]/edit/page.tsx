/**
 * Talent Library - Skill Edit Page
 */
...
export default async function EditSkillPage({ params }: EditSkillPageProps) {
  ...
  if (!(await canAccessLibrary(session.user.id, 'talent'))) {
    redirect('/v2');
  }

  // Fetch skill
  const skill = await getSkillWithRelations(slug, 'talent', null);
